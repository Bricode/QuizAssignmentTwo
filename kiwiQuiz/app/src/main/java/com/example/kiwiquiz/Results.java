...
public class Results extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        System.out.println(scoresStorage.length);
    ...
    private void calculateScore(int[] total) {
        ...
        answeredCorrectly = (answeredCorrectly.length() > 0)? answeredCorrectly.substring(0,answeredCorrectly.length() - 1): "no questions";
        answeredIncorrectly = (answeredIncorrectly.length() > 0)?answeredIncorrectly.substring(0,answeredIncorrectly.length() - 1):"no questions";
